 ...
 */
ace_status_t aceAlloc_initWithAllocator(
    aceAlloc_allocator_t* allocators, size_t count
);
 ...
 */
void* aceAlloc_alloc(
    aceModules_moduleId_t module_id, aceAlloc_bufferType_t buf_type, size_t size
);
 ...
 *  @return the pointer to the allocated buffer on success, else NULL
 */
void* aceAlloc_calloc(
    aceModules_moduleId_t module_id, aceAlloc_bufferType_t buf_type,
 ...
 */
void aceAlloc_free(
    aceModules_moduleId_t module_id,
